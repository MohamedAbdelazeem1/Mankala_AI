...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.pocket1.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket2.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket3.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket4.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket5.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket6.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket7.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket8.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket9.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket10.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket11.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.pocket12.setStyleSheet("color: white;""background-color: grey;""border-radius : 30px; border : 2px solid white" )
        ...
        self.mankla1.setStyleSheet("color: white;""background-color: grey;" "selection-color: red;""selection-background-color: blue;")
        ...
        self.mankla2.setStyleSheet("color: white;""background-color: grey;" "selection-color: red;""selection-background-color: blue;")
    ...
    def set_game_state(self , game_state):
        ...
        self.pocket1.setText(str(game_state['mankala_state'][0]))
        self.pocket2.setText(str(game_state['mankala_state'][1]))
        self.pocket3.setText(str(game_state['mankala_state'][2]))
        self.pocket4.setText(str(game_state['mankala_state'][3]))
        self.pocket5.setText(str(game_state['mankala_state'][4]))
        self.pocket6.setText(str(game_state['mankala_state'][5]))
        self.mankla1.setText(str(game_state['mankala_state'][6]))

        self.pocket7.setText(str(game_state['mankala_state'][7]))
        self.pocket8.setText(str(game_state['mankala_state'][8]))
        self.pocket9.setText(str(game_state['mankala_state'][9]))
        self.pocket10.setText(str(game_state['mankala_state'][10]))
        self.pocket11.setText(str(game_state['mankala_state'][11]))
        self.pocket12.setText(str(game_state['mankala_state'][12]))
        self.mankla2.setText(str(game_state['mankala_state'][13]))
        ...
        # for i in range(6):
        #     self.pocket+(i+1).setText(game_state['mankala_state'][i])

        # for i in range(6):
        #     self.pocket+(i+7).setText(game_state['mankala_state'][i+7])
    ...
    def get_game_state(self):
        ...
        ps['mankala_state'].clear()
        print(ps['mankala_state'])

        ps['mankala_state'].append(self.pocket1.text())
        ps['mankala_state'].append(self.pocket2.text())
        ps['mankala_state'].append(self.pocket3.text())
        ps['mankala_state'].append(self.pocket4.text())
        ps['mankala_state'].append(self.pocket5.text())
        ps['mankala_state'].append(self.pocket6.text())
        ps['mankala_state'].append(self.mankla1.text())
        ps['mankala_state'].append(self.pocket7.text())
        ps['mankala_state'].append(self.pocket8.text())
        ps['mankala_state'].append(self.pocket9.text())
        ps['mankala_state'].append(self.pocket10.text())
        ps['mankala_state'].append(self.pocket11.text())
        ps['mankala_state'].append(self.pocket12.text())
        ps['mankala_state'].append(self.mankla2.text())
